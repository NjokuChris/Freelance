                        ...
                        <div class="card-body" >
                            <form  method="post" action="{{ route('stories.store') }}" enctype="multipart/form-data" class="container">
                                ...
                                <div class="form-group">
                                            ...
                                            @foreach($freelancers as $freelancer)
                                                <div class="dropdown-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="freelancers[]" type="checkbox" value="{{$freelancer->id}}" id="defaultCheck{{$freelancer->id}}">
                                    ...
                                    {{-- <select class="form-control" name="freelancers[]" id="exampleFormControlSelect4" multiple>
                                        <option selected disabled>Select freelancers</option>
                                        @foreach($freelancers as $freelancer)
                                            <option value="{{ $freelancer->id }}">{{ $freelancer->full_name }}</option>
                                        @endforeach
                                    </select> --}}
                                </div>
